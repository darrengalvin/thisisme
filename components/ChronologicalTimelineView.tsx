              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
                ...
                <div className="bg-slate-50 rounded-xl p-6 mb-8">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                      { icon: "🎓", title: "School Years", desc: "Primary, secondary, university" },
                      { icon: "💼", title: "Career Milestones", desc: "First job, promotions, changes" },
                      { icon: "❤️", title: "Relationships", desc: "Meeting partners, friendships" },
                      { icon: "🏠", title: "Places I've Lived", desc: "Homes, cities, countries" },
                      { icon: "✈️", title: "Travel Adventures", desc: "Holidays, trips, explorations" },
                      { icon: "👶", title: "Family Moments", desc: "Children, weddings, celebrations" }
                    ].map((idea, index) => (
                ...
                <div className="text-center">
                  <button
                    onClick={() => setShowCreateChapterModal(true)}
                    className="bg-slate-800 hover:bg-slate-900 text-white py-4 px-8 rounded-xl text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    📖 Create Your First Chapter
                  </button>
                  <p className="text-sm text-slate-500 mt-4">
                    You can always add memories to your chapters later
                  </p>
                </div>
              </div>
            </div>
