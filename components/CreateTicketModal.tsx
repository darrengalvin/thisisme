    ...
    try {
      ...
      if (screenshot) {
        ...
        if (uploadResponse.ok) {
          ...
          console.warn('Screenshot upload failed, proceeding without image')
        }
      }
      ...
      const response = await fetch('/api/support/tickets', {
        ...
        body: JSON.stringify({
          ...
          metadata: {
            ...
            screenshot_url: screenshotUrl,
            visual_context: screenshotUrl ? 'Screenshot provided for visual AI analysis' : null
          }
        })
      })
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-sm text-blue-800">
                      <p className="font-medium">Why upload a screenshot?</p>
                      <p>Screenshots help our AI system identify exactly which UI component has the issue, leading to more accurate fixes.</p>
                    </div>
                  </div>
                </div>
