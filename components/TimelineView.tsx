                                  ...
                                  <div key={media.id} className="rounded-xl overflow-hidden">
                                    {media.type === 'IMAGE' && (
                                      <img 
                                        ...
                                        alt={memory.title || ''} 
                                        className="w-full max-w-sm h-auto mx-auto object-contain cursor-pointer hover:scale-105 transition-transform duration-300"
                                    ...
                                    {media.type === 'VIDEO' && (
                                      <video 
                                        src={media.storage_url} 
                                        controls 
                                        className="w-full max-w-sm max-h-96 mx-auto rounded-xl"
